...
'           <image id="picItem" src="<?php echo base_url()?>assets/img/show/new-product.jpg" style="width: 220px; height: 180px; margin: auto; display: block;" class="shadow" />'+
...
'<!--</form>-->';
                        ...
                        $(function(){
                            ...
                            $("#submit_item").click(function(event){
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '<?php echo site_url("../../item/addNewItem")?>',
                                    data: $objItem,
                                    dataType: "JSON",
                                }).done(function( data ) {
                                ...
                                if(isImage(fileExtension)){
                                    $.ajax({
                                        url: '<?php echo base_url()?>index.php/item/upload_file',  
                                        type: 'POST',
                                        data: formData,
                                        cache: false,
                                        contentType: false,
